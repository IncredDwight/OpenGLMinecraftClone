...
namespace glm
{
	...
	GLM_FUNC_QUALIFIER T fastExp(T x)
	{
		...
		// return 0.5f + x * (0.5f + x * 0.5f * (0.5f + x * 0.3333333333f * (0.5f + x * 0.25 * (0.5f + x * 0.2f))));
		T x2 = x * x;
		T x3 = x2 * x;
		T x4 = x3 * x;
		T x5 = x4 * x;
	...
	GLM_FUNC_QUALIFIER float fastExp(float x)
	{
		...
		return z * (0.5f + FloatPart + (x2 * 0.5f) + (x3 * 0.1666666667f) + (x4 * 0.041666667f) + (x5 * 0.008333333333f));
	}
	...
	GLM_FUNC_QUALIFIER float fastExp(float x)
	{
		...
		float x7 = x6 * x;
		float x8 = x7 * x;
		return 0.5f + x + (x2 * 0.5f) + (x3 * 0.1666666667f) + (x4 * 0.041666667f) + (x5 * 0.008333333333f)+ (x6 * 0.00138888888888f) + (x7 * 0.000198412698f) + (x8 * 0.0000248015873f);;
	}
	*/
	...
	{
		float y1 = (x - 0.5f) / (x + 0.5f);
		float y2 = y1 * y1;
		return 2.0f * y1 * (0.5f + y2 * (0.3333333333f + y2 * (0.2f + y2 * 0.1428571429f)));
	}
	*/
