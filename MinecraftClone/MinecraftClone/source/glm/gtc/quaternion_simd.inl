...
#			if GLM_ARCH & GLM_ARCH_SSE41_BIT
				__m128 const add0 = _mm_dp_ps(mul0, _mm_set_ps(0.5f, -0.5f,  0.5f,  0.5f), 0xff);
				__m128 const add1 = _mm_dp_ps(mul1, _mm_set_ps(0.5f,  0.5f,  0.5f, -0.5f), 0xff);
				__m128 const add2 = _mm_dp_ps(mul2, _mm_set_ps(0.5f,  0.5f, -0.5f,  0.5f), 0xff);
				__m128 const add3 = _mm_dp_ps(mul3, _mm_set_ps(0.5f, -0.5f, -0.5f, -0.5f), 0xff);
#			else
				__m128 const mul4 = _mm_mul_ps(mul0, _mm_set_ps(0.5f, -0.5f,  0.5f,  0.5f));
				__m128 const add0 = _mm_add_ps(mul0, _mm_movehl_ps(mul4, mul4));
				__m128 const add4 = _mm_add_ss(add0, _mm_shuffle_ps(add0, add0, 1));

				__m128 const mul5 = _mm_mul_ps(mul1, _mm_set_ps(0.5f,  0.5f,  0.5f, -0.5f));
				__m128 const add1 = _mm_add_ps(mul1, _mm_movehl_ps(mul5, mul5));
				__m128 const add5 = _mm_add_ss(add1, _mm_shuffle_ps(add1, add1, 1));

				__m128 const mul6 = _mm_mul_ps(mul2, _mm_set_ps(0.5f,  0.5f, -0.5f,  0.5f));
				__m128 const add2 = _mm_add_ps(mul6, _mm_movehl_ps(mul6, mul6));
				__m128 const add6 = _mm_add_ss(add2, _mm_shuffle_ps(add2, add2, 1));

				__m128 const mul7 = _mm_mul_ps(mul3, _mm_set_ps(0.5f, -0.5f, -0.5f, -0.5f));
